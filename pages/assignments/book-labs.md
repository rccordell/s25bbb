...
3. Finally, an analytical reflection that puts the lab activity into conversation with _at least one_ reading _from the same week of class_ as the lab, as well as _at least one_ reading drawn from the larger syllabus, or even beyond the class where appropriate. This prose need not be as formal as a research paper, but it should demonstrate careful thought and preparation. You should integrate the readings explicitly, if possible through direct quotation.
